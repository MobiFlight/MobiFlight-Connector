...
namespace AutoUpdaterDotNET
{
    ...
    public static class AutoUpdater
    {
        ...
        public static void Start(String appCast, bool force = false, bool silent = false)
        {
            AppCastURL = appCast;
        ...
        private static void BackgroundWorkerDoWork(object sender, DoWorkEventArgs e)
        {
            ...
            bool force = (bool) (e.Argument as List<Object>)[0];
            bool silent = (bool) (e.Argument as List<Object>)[1];

            if (updateKey != null)
            {
                object remindLaterTime = updateKey.GetValue("remindlater");

                // evaluate this only if force is not set to "true"
                if (!force && remindLaterTime != null)
                {
    ...
    public class UpdateInfoEventArgs : EventArgs
    {
        ...
        ///     Returns version of the application currently installed on the user's PC.
        /// </summary>
        public Boolean DoSilent { get; set; }
    }
}