...
{
    [TestClass]
    public class WinCtrlAirbusSidestickControllerTests
    {
        ...
        private WinCtrlAirbusSidestickController CreateDevice(string stickType)
        {
            return new WinCtrlAirbusSidestickController(mockMessageSender, stickType);
        }

        #region Basic Properties Tests

        [TestMethod]
        [DataRow("Airbus Sidestick Left",  "WinCtrl Airbus Sidestick Left")]
        [DataRow("Airbus Sidestick Right", "WinCtrl Airbus Sidestick Right")]
        public void Name_PrefixesWinCtrlToStickType(string stickType, string expectedName)
        {
