...
{
    [TestClass]
    public class WinCtrlRmpControllerTests
    {
        private MockWinCtrlMessageSender mockMessageSender = null!;
        private WinCtrlRmpController device = null!;
        ...
        public void Setup()
        {
            ...
            device = new WinCtrlRmpController(mockMessageSender, "RMP Center");
        }
        ...
        [TestMethod]
        public void Name_CenterVariant_ReturnsWinCtrlRmpCenter()
        {
            Assert.AreEqual("WinCtrl RMP Center", device.Name);
        }

        [TestMethod]
        public void Name_LeftAndRightVariant_ContainVariantName()
        {
            Assert.AreEqual("WinCtrl RMP Left",  new WinCtrlRmpController(mockMessageSender, "RMP Left").Name);
            Assert.AreEqual("WinCtrl RMP Right", new WinCtrlRmpController(mockMessageSender, "RMP Right").Name);
        }
