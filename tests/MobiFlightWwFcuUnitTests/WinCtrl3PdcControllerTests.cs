...
{
    [TestClass]
    public class WinCtrl3PdcControllerTests
    {
        ...
        private WinCtrl3PdcController CreateDevice(string pdcType)
        {
            return new WinCtrl3PdcController(mockMessageSender, pdcType);
        }

        #region Basic Properties Tests

        [TestMethod]
        [DataRow("3N PDC Left",  "WinCtrl 3N PDC Left")]
        [DataRow("3N PDC Right", "WinCtrl 3N PDC Right")]
        [DataRow("3M PDC Left",  "WinCtrl 3M PDC Left")]
        [DataRow("3M PDC Right", "WinCtrl 3M PDC Right")]
        public void Name_PrefixesWinCtrlToPdcType(string pdcType, string expectedName)
        {
