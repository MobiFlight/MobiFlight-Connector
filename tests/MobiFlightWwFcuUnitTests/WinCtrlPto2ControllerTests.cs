...
{
    [TestClass]
    public class WinCtrlPto2ControllerTests
    {
        private MockWinCtrlMessageSender mockMessageSender = null!;
        private WinCtrlPto2Controller device = null!;

        [TestInitialize]
        public void Setup()
        {
            mockMessageSender = new MockWinCtrlMessageSender();
            device = new WinCtrlPto2Controller(mockMessageSender);
        }
        ...
        {
            Assert.AreEqual("WinCtrl PTO2", device.Name);
        }
