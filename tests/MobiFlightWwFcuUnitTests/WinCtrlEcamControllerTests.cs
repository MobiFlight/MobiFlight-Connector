...
{
    [TestClass]
    public class WinCtrlEcamControllerTests
    {
        private MockWinCtrlMessageSender mockMessageSender = null!;
        private WinCtrlEcamController device = null!;

        [TestInitialize]
        public void Setup()
        {
            mockMessageSender = new MockWinCtrlMessageSender();
            device = new WinCtrlEcamController(mockMessageSender);
        }
        ...
        {
            Assert.AreEqual("WinCtrl ECAM", device.Name);
        }
