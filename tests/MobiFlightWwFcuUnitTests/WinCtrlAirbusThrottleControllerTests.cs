...
{
    [TestClass]
    public class WinCtrlAirbusThrottleControllerTests
    {
        ...
        private WinCtrlAirbusThrottleController CreateDevice(string throttleType)
        {
            return new WinCtrlAirbusThrottleController(mockMessageSender, throttleType);
        }

        #region Basic Properties Tests

        [TestMethod]
        [DataRow("Airbus Throttle Left",  "WinCtrl Airbus Throttle Left")]
        [DataRow("Airbus Throttle Right", "WinCtrl Airbus Throttle Right")]
        public void Name_PrefixesWinCtrlToThrottleType(string throttleType, string expectedName)
        {
