...
{
    [TestClass]
    public class WinCtrlNwsControllerTests
    {
        ...
        private WinCtrlNwsController CreateDevice(string variantName)
        {
            return new WinCtrlNwsController(mockMessageSender, variantName);
        }

        #region Basic Properties Tests

        [TestMethod]
        [DataRow("NWS Left",  "WinCtrl NWS Left")]
        [DataRow("NWS Right", "WinCtrl NWS Right")]
        public void Name_PrefixesWinCtrlToVariantName(string variantName, string expectedName)
        {
