...
%ARDUINO_DIR%\arduino-builder -compile -logger=human -hardware %ARDUINO_DIR%\hardware -hardware %FW_SOURCE_DIR%\packages -tools %ARDUINO_DIR%\tools-builder -tools %ARDUINO_DIR%\hardware\tools\avr -tools %FW_SOURCE_DIR%\packages -built-in-libraries %ARDUINO_DIR%\libraries -libraries %ARDUINO_DIR%\sketchbooks\libraries -fqbn=arduino:avr:mega:cpu=atmega2560 -vid-pid=0X2341_0X0042 -ide-version=10800 -build-path %TEMP_DIR% -warnings=default -prefs=build.warn_data_percentage=75 -prefs=runtime.tools.avrdude.path=%ARDUINO_DIR%\hardware\tools\avr -prefs=runtime.tools.avr-gcc.path=%ARDUINO_DIR%\hardware\tools\avr -prefs=runtime.tools.arduinoOTA.path=%ARDUINO_DIR%\hardware\tools\avr %FW_SOURCE_DIR%\mobiflight\mobiflight.ino
...
%ARDUINO_DIR%\arduino-builder -compile -logger=human -hardware %ARDUINO_DIR%\hardware -hardware %FW_SOURCE_DIR%\packages -tools %ARDUINO_DIR%\tools-builder -tools %ARDUINO_DIR%\hardware\tools\avr -tools %FW_SOURCE_DIR%\packages -built-in-libraries %ARDUINO_DIR%\libraries -libraries %ARDUINO_DIR%\sketchbooks\libraries -fqbn=SparkFun:avr:promicro:cpu=16MHzatmega32U4 -vid-pid=0X2341_0X0042 -ide-version=10800 -build-path %TEMP_DIR% -warnings=default -prefs=build.warn_data_percentage=75 -prefs=runtime.tools.avrdude.path=%ARDUINO_DIR%\hardware\tools\avr -prefs=runtime.tools.avr-gcc.path=%ARDUINO_DIR%\hardware\tools\avr -prefs=runtime.tools.arduinoOTA.path=%ARDUINO_DIR%\hardware\tools\avr %FW_SOURCE_DIR%\mobiflight\mobiflight.ino
copy %TEMP_DIR%\mobiflight.ino.hex %RELEASE_DIR%\mobiflight_micro_%VERSION%.hex

echo -----------------------------------------------------------
echo Building UNO (experimental)
echo -----------------------------------------------------------
...
%ARDUINO_DIR%\arduino-builder -compile -logger=human -hardware %ARDUINO_DIR%\hardware -hardware %FW_SOURCE_DIR%\packages -tools %ARDUINO_DIR%\tools-builder -tools %ARDUINO_DIR%\hardware\tools\avr -tools %FW_SOURCE_DIR%\packages -built-in-libraries %ARDUINO_DIR%\libraries -libraries %ARDUINO_DIR%\sketchbooks\libraries -fqbn=arduino:avr:uno -vid-pid=0X2341_0X0042 -ide-version=10800 -build-path %TEMP_DIR% -warnings=default -prefs=build.warn_data_percentage=75 -prefs=runtime.tools.avrdude.path=%ARDUINO_DIR%\hardware\tools\avr -prefs=runtime.tools.avr-gcc.path=%ARDUINO_DIR%\hardware\tools\avr -prefs=runtime.tools.arduinoOTA.path=%ARDUINO_DIR%\hardware\tools\avr %FW_SOURCE_DIR%\mobiflight\mobiflight.ino
