...
namespace MobiFlight.InputConfig
{
    ...
    public class DigInputMuxConfig : ButtonInputConfig
    {
        ...
        {
            // Digital input multiplexer configurations are equal when their data pin is the same
            // and all of the button configuration from the base class matches.
            return (obj is DigInputMuxConfig) && ((obj as DigInputMuxConfig).pin == pin) && base.Equals(obj);
        }
