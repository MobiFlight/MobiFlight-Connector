...
namespace MobiFlight.Joysticks.Bodnar
{
    public class BU0836XReport
    {
        ...
        public BU0836XReport Parse(byte[] inputBuffer)
        {
            var result = new BU0836XReport();
            result.CopyFromInputBuffer(inputBuffer);

            return result;
        }

        public JoystickState ToJoystickState(List<JoystickDevice> Axis, int ButtonCount = 32)
        {
