...
{
    internal class BU0836X : Joystick
    {
        /// <summary>
        ...
        /// </summary>
        private readonly BodnarReport report = new BodnarReport(buttonCount: 32, expectedBufferLength: BodnarReport.REPORT_LENGTH_BU0836X);
        ...
        public BU0836X(SharpDX.DirectInput.Joystick joystick, JoystickDefinition definition) : base(joystick, definition)
        {
        }
