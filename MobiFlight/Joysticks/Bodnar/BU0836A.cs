...
{
    internal class BU0836A : Joystick
    {
        /// <summary>
        ...
        /// </summary>
        private readonly BodnarReport report = new BodnarReport(buttonCount: 12);
        ...
        public BU0836A(SharpDX.DirectInput.Joystick joystick, JoystickDefinition definition) : base(joystick, definition)
        {
        }
