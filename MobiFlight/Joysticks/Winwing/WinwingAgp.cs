...
{
    internal class WinwingAgp : Joystick
    {
        ...
        public WinwingAgp(SharpDX.DirectInput.Joystick joystick, JoystickDefinition def, int productId, WebSocketServer server) : base(joystick, def)
        {
            Log.Instance.log($"WinwingAgp - New WinwingAgp ProductId={productId.ToString("X")}", LogSeverity.Debug);
