...
namespace MobiFlight.Joysticks.Winwing
{
    internal class WinwingAirbusSidestick : Joystick
    {
        ...
        public WinwingAirbusSidestick(SharpDX.DirectInput.Joystick joystick, JoystickDefinition def, int productId, WebSocketServer server) : base(joystick, def)
        {
            Log.Instance.log($"WinwingAirbusSidestick - New WinwingAirbusSidestick ProductId={productId.ToString("X")}", LogSeverity.Debug);
