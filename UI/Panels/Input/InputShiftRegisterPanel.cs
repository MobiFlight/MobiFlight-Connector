...
namespace MobiFlight.UI.Panels.Input
{
    public partial class InputShiftRegisterPanel : UserControl
    {
        ...
        {
            InputConfig.InputShiftRegisterConfig config = new InputShiftRegisterConfig();
            ToConfig(config);
        ...
        private void UpdatePanelWithAction(Panel owner, InputShiftRegisterConfig config, string value, bool isOnPress)
        {
            this.SuspendLayout();
            Control panel = null;
        ...
        public void syncFromConfig(InputConfig.InputShiftRegisterConfig config)
        {
        ...
        public void ToConfig(InputConfig.InputShiftRegisterConfig config)
        {
