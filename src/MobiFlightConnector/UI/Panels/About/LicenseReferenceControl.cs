...
namespace MobiFlight.UI.Panels.About
{
    public partial class LicenseReferenceControl : UserControl
    {
        ...
        {
            InitializeComponent();
            LicenseLinkLabel.Click += (s, e) => { LicenseLinkLabel.LinkVisited = true; ProcessHelpers.OpenUrl(LicenseLink); };
            LibraryLinkLabel.Click += (s, e) => { LibraryLinkLabel.LinkVisited = true; ProcessHelpers.OpenUrl(LibraryLink); };
        }
    }
}
