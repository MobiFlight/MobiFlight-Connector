...
{
    internal class WinCtrlFcuReport
    {
        ...
        public void CopyTo(WinCtrlFcuReport targetReport)
        {
        ...
        public void ParseReport(byte reportId, byte[] data)
        {
            ...
            else if (ReportId == DEVICE_REPORT)
            {
                ...
                if (data[5] == 0x02 && data[4] == 0x05)
                {
                    ...
                    {
                        LogFirmware(data, "WINCTRL EFIS-L");
                    }
                    else if (data[0] == 0x0e && data[1] == 0xcf)
                    {
                        LogFirmware(data, "WINCTRL EFIS-R");
                    }
                }
            }
        }
