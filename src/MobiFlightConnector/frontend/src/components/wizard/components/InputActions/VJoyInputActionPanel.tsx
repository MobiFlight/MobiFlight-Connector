        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            <Label htmlFor="joystick">
              {t(
                "Dialog.InputConfigWizard.InputActions.VJoy.SelectDeviceLabel",
              )}
            </Label>
            <ComboBox
              placeholder={t(
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex flex-row items-center gap-2">
                    ...
                    >
                      {config?.buttonComand
                        ? t(
                            "Dialog.InputConfigWizard.InputActions.VJoy.Pressed",
                          )
                        : t(
                            "Dialog.InputConfigWizard.InputActions.VJoy.Released",
                          )}
                    </span>
                  </div>
                </div>
            ...
            <TabsContent key="axis" value="axis">
              <div className="flex flex-col gap-4 pt-2">
                <ComboBox
                  ...
                  selected={axisOptions.find(
                    (item) => item === config?.axisString,
                  )}
                  setSelected={(item) =>
                    setConfig({
                      ...(config ?? {}),
                ...
                <div className="flex flex-col gap-2">
                  <Label htmlFor="axisValue">
                    {t(
                      "Dialog.InputConfigWizard.InputActions.VJoy.AxisValueLabel",
                    )}
                  </Label>
                  <Input
