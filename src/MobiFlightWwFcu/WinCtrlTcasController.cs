...
{
    internal class WinCtrlTcasController : SegmentDisplayControllerBase
    {
        public override string Name => "WinCtrl TCAS";
        ...
        public WinCtrlTcasController(IWinCtrlMessageSender sender)
            : base(sender, WinCtrlConstants.DEST_TCAS, 0x35)  // 53 bytes: 4 dest addr + 13 header + 36 data
        {
