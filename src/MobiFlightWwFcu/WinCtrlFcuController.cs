...
{
    internal class WinCtrlFcuController : SegmentDisplayControllerBase
    {
        public override string Name => "WinCtrl FCU";
        ...
        public WinCtrlFcuController(IWinCtrlMessageSender sender)
            : base(sender, WinCtrlConstants.DEST_FCU, 0x31)
        {
