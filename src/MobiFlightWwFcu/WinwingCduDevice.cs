...
namespace MobiFlightWwFcu
{
    internal class WinwingCduDevice : IWinwingDevice
   {
        ...
        private List<Tuple<string, byte[]>> InitCommandHeaderMcdu = new List<Tuple<string, byte[]>>()
        {
            ...
            new Tuple<string, byte[]>("1801", new byte[] {0x34, 0x00, 0x2c, 0x00, 0x0e, 0x00, 0x18, 0x00}), // SetScreenInfo x-Axis: 16 = 0x34[16! + 36] y-Axis: 24 =  0x2c[24! + 20] LineCount: 0x0e[14] ColumnCount: 0x18[24]
