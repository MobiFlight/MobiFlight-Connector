...
{
    internal class WinCtrlRmpController : SegmentDisplayControllerBase
    {
        public override string Name => $"WinCtrl {RmpType}";
        ...
        public WinCtrlRmpController(IWinCtrlMessageSender sender, string rmpType)
            : base(sender, WinCtrlConstants.DEST_RMP, 0x91)
        {
            RmpType = rmpType;
        ...
        // the segment order [T, TR, BR, B, BL, TL, M] of WinCtrlConstants.CharacterDict.
