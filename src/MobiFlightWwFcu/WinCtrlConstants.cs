...
namespace MobiFlightWwFcu
{
    public class WinCtrlConstants
    {
        ...
        public const int PRODUCT_ID_FCU_ONLY = 0xBB10;
        public const int PRODUCT_ID_FCU_EFISL = 0xBC1D;
        public const int PRODUCT_ID_FCU_EFISR = 0xBC1E;
        public const int PRODUCT_ID_FCU_EFISL_EFISR = 0xBA01;

        public const int PRODUCT_ID_PFP3N_CPT = 0xBB35;
        public const int PRODUCT_ID_PFP3N_OBS = 0xBB39;
        public const int PRODUCT_ID_PFP3N_FO = 0xBB3D;

        public const int PRODUCT_ID_MCDU_CPT = 0xBB36;
        public const int PRODUCT_ID_MCDU_OBS = 0xBB3A;
        public const int PRODUCT_ID_MCDU_FO = 0xBB3E;

        public const int PRODUCT_ID_PFP7_CPT = 0xBB37;
        public const int PRODUCT_ID_PFP7_OBS = 0xBB3B;
        public const int PRODUCT_ID_PFP7_FO = 0xBB3F;

        public const int PRODUCT_ID_PFP4_CPT = 0xBB38;
        public const int PRODUCT_ID_PFP4_OBS = 0xBB3C;
        public const int PRODUCT_ID_PFP4_FO = 0xBB40;

        public const int PRODUCT_ID_PAP3 = 0xBF0F;

        public const int PRODUCT_ID_3NPDCL = 0xBB61;
        public const int PRODUCT_ID_3NPDCR = 0xBB62;
        public const int PRODUCT_ID_3MPDCL = 0xBB51;
        public const int PRODUCT_ID_3MPDCR = 0xBB52;

        public const int PRODUCT_ID_AIRBUS_THROTTLE_L = 0xB920;
        public const int PRODUCT_ID_AIRBUS_THROTTLE_R = 0xB930;

        public const int PRODUCT_ID_AIRBUS_STICK_L = 0xBC27;
        public const int PRODUCT_ID_AIRBUS_STICK_R = 0xBC28;

        public const int PRODUCT_ID_ECAM = 0xBB70;
        public const int PRODUCT_ID_AGP  = 0xBB80;
        public const int PRODUCT_ID_TCAS = 0xBB81;

        public const int PRODUCT_ID_PTO2 = 0xBF05;

        public const int PRODUCT_ID_RMP_L = 0xBB83;
        public const int PRODUCT_ID_RMP_R = 0xBB84;
        public const int PRODUCT_ID_RMP_C = 0xBB85;

        public const int PRODUCT_ID_NWS_L = 0xB961;
        public const int PRODUCT_ID_NWS_R = 0xB962;

        public static readonly int[] FCU_PRODUCTIDS = { PRODUCT_ID_FCU_ONLY, PRODUCT_ID_FCU_EFISL, PRODUCT_ID_FCU_EFISR, PRODUCT_ID_FCU_EFISL_EFISR };
        public static readonly int[] CDU_PRODUCTIDS = { PRODUCT_ID_MCDU_CPT, PRODUCT_ID_MCDU_OBS, PRODUCT_ID_MCDU_FO,
        ...
        public static readonly int[] PAP3_PRODUCTIDS = { PRODUCT_ID_PAP3 };
        public static readonly int[] AIRBUS_THROTTLE_PRODUCTIDS = { PRODUCT_ID_AIRBUS_THROTTLE_L, PRODUCT_ID_AIRBUS_THROTTLE_R };
        public static readonly int[] AIRBUS_STICK_PRODUCTIDS = { PRODUCT_ID_AIRBUS_STICK_L, PRODUCT_ID_AIRBUS_STICK_R };
        public static readonly int[] PDC3_PRODUCTIDS = { PRODUCT_ID_3NPDCL, PRODUCT_ID_3NPDCR, PRODUCT_ID_3MPDCL, PRODUCT_ID_3MPDCR };
        public static readonly int[] RMP_PRODUCTIDS = { PRODUCT_ID_RMP_L, PRODUCT_ID_RMP_R, PRODUCT_ID_RMP_C };
        public static readonly int[] NWS_PRODUCTIDS = { PRODUCT_ID_NWS_L, PRODUCT_ID_NWS_R };

        public const string CDU_DATA = "Cdu Data";
        public const string FONT_DATA = "Font Data";

        /// <summary>
        /// The "-> MOBIFLIGHT <-" splash sent as the first CDU page on connect - shared by
        /// every CDU-class product (WinCtrl and MOZA alike), not WinCtrl-specific.
        /// </summary>
        public const string InitialDisplayJson =
            @"{
                ""Target"": ""Display"",
                ""Data"": [[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],
                           [],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],
