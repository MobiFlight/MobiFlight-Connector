...
{
    internal class WinCtrlAgpController : SegmentDisplayControllerBase
    {
        public override string Name => "WinCtrl AGP";
        ...
        public WinCtrlAgpController(IWinCtrlMessageSender sender)
            : base(sender, WinCtrlConstants.DEST_AGP, 0x35)  // 53 bytes: 4 dest addr + 13 header + 36 data
        {
