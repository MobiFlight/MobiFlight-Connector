...
{
    internal abstract class WinCtrlControllerBase : IWinCtrlController
    {
        ...
        protected readonly IWinCtrlMessageSender MessageSender;
        ...
        protected WinCtrlControllerBase(IWinCtrlMessageSender sender, byte[] destinationAddress)
        {
