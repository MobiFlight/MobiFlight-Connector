        ...
        private void Init(int productId, WebSocketServer server)
        {
            ...
            switch (ProductId)
            {
                ...
                case WinwingConstants.PRODUCT_ID_AGP:
                    ...
                    break;
                case WinwingConstants.PRODUCT_ID_TCAS:
                    AddToCoupledDevices(new WinwingTcasDevice(MessageSender));
                    break;
                case WinwingConstants.PRODUCT_ID_PTO2:
                    AddToCoupledDevices(new WinwingPto2Device(MessageSender));
                    break;
                case WinwingConstants.PRODUCT_ID_RMP_L:
                    AddToCoupledDevices(new WinwingRmpDevice(MessageSender, WinwingConstants.RMP_L_NAME));
                    break;
                case WinwingConstants.PRODUCT_ID_RMP_R:
                    AddToCoupledDevices(new WinwingRmpDevice(MessageSender, WinwingConstants.RMP_R_NAME));
                    break;
                ...
                case WinwingConstants.PRODUCT_ID_PFP3N_OBS:
                    ...
                    break;
                case WinwingConstants.PRODUCT_ID_PFP7_CPT:
                    AddCduDevice("/winwing/cdu-captain", WinwingCduType.PFP7);
                    break;
                case WinwingConstants.PRODUCT_ID_PFP7_FO:
                    AddCduDevice("/winwing/cdu-co-pilot", WinwingCduType.PFP7);
                    break;
