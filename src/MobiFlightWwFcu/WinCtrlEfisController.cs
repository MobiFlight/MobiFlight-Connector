...
{
    internal class WinCtrlEfisController : SegmentDisplayControllerBase
    {
        public override string Name => $"WinCtrl EFIS {EfisType}";
        ...
        public WinCtrlEfisController(IWinCtrlMessageSender sender, string efisType)
