...
{
    internal abstract class SegmentDisplayControllerBase : WinCtrlControllerBase
    {
        ...
        protected SegmentDisplayControllerBase(IWinCtrlMessageSender sender, byte[] destinationAddress, int setValuesSize)
        ...
        // Subclasses provide the header keys defined in WinCtrlConstants.DisplayCmdHeaders.
        ...
        private void BuildHeader(byte[] target, string headerKey)
        {
            ...
            init.AddRange(WinCtrlConstants.DisplayCmdHeaders[headerKey]);
