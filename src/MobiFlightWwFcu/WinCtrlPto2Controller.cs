...
{
    internal class WinCtrlPto2Controller : SimpleOutputControllerBase
    {
        public override string Name => "WinCtrl PTO2";
        ...
        public WinCtrlPto2Controller(IWinCtrlMessageSender sender)
            : base(sender, WinCtrlConstants.DEST_PTO2)
        {
