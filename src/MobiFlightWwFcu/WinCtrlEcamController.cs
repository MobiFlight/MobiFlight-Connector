...
{
    internal class WinCtrlEcamController : SimpleOutputControllerBase
    {
        public override string Name => "WinCtrl ECAM";

        public WinCtrlEcamController(IWinCtrlMessageSender sender)
            : base(sender, WinCtrlConstants.DEST_ECAM)
        {
