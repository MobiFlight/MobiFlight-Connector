...
{
    internal class WinCtrlPap3Controller : SegmentDisplayControllerBase
    {
        public override string Name => "WinCtrl PAP3";
        ...
        public WinCtrlPap3Controller(IWinCtrlMessageSender sender)
            : base(sender, WinCtrlConstants.DEST_PAP3, 0x3C)  // 60 = max content message: 4 + 13 + 43 data
        {
