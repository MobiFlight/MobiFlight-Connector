...
{
    internal class WinCtrlAirbusThrottleController : SegmentDisplayControllerBase
    {
        public override string Name => $"WinCtrl {ThrottleType}";
        ...
        private readonly byte[] DestinationAddressPac = WinCtrlConstants.DEST_AIRBUS_PAC;
        ...
        public WinCtrlAirbusThrottleController(IWinCtrlMessageSender sender, string throttleType)
            : base(sender, WinCtrlConstants.DEST_AIRBUS_THROTTLE, 0x35)  // 53 bytes: 4 dest addr + 13 header + 36 data
        {
