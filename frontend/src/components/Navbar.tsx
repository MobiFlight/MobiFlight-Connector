...
import RunControl from "./mobiflight/RunControl";
// import HubHopLogo from '@/assets/mobiflight-logo-border.png'

const Navbar = () => {
  return (
    <div className="flex flex-row h-12 justify-between items-center pr-16 gap-4 shadow-gray-300 dark:shadow-gray-800 dark:shadow-lg shadow-md">
      <div className="pl-12">
        <RunControl />
      </div>
      <div className="flex flex-row gap-4">
        <div className="lg:flex lg:flex-row gap-4 hidden lg:visible">
