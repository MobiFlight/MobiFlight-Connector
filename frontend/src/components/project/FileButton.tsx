...
const FileButton = ({
  ...
  const groupHoverStyle = variant === "tabActive" ? "group-hover:bg-primary/90 group-hover:text-primary-foreground" : "group-hover:bg-accent group-hover:text-accent-foreground"
