...
const StartupProgress = (props: StartupProgressProps) => {
  ...
  return (
    <>
      <div className="fixed inset-0 bg-gradient-to-br from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% dark:from-indigo-500/10 dark:via-sky-500/0 dark:via-70% dark:to-emerald-500/5"></div>
      <div className="relative flex min-h-screen flex-col items-center justify-center gap-8 p-10">
        ...
        <div className="dark:h-10 rounded-full w-full max-w-xl dark:bg-gradient-to-br dark:from-indigo-500 dark:from-10% dark:via-sky-500 dark:via-30% dark:to-emerald-500 dark:to-90% p-0.5">
