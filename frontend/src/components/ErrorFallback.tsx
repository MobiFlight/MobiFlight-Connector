...
const ErrorFallback = ({ error }: FallbackProps) => {
  ...
  const errorMessage =
    (error as Error).message || error?.toString() || t("General.Error.Unknown")

  return (
    <div className="flex h-full w-full flex-col items-center justify-center p-4 text-red-500" data-testid="error-fallback">
